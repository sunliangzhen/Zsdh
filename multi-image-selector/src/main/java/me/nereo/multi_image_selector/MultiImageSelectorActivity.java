...
public class MultiImageSelectorActivity extends AppCompatActivity
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.e("dd", "1111111111111111111111111111111");
        if (resultCode == Activity.RESULT_OK) {
            Log.e("dd", "2222222222222222222");
            switch (requestCode) {
                case UCrop.REQUEST_CROP:
                    Log.e("dd", "3333333333333");
...
//        }
    ...
    private void handleCrop(Intent result) {
        ...
        sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.fromFile(new File(resultUri.getPath()))));
        onSingleImageSelected(resultUri.getPath());
    }
