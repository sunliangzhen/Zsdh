...
public class CycleView extends View {
    ...
    private void InitResources(Context context, AttributeSet attrs) {
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.windows2);

        background_int = mTypedArray.getColor(R.styleable.windows2_background2, 0xFF87cfe8);
        progress_int = mTypedArray.getColor(R.styleable.windows2_progressDrawable2, 0xFFabd800);
        layout_width_float = mTypedArray.getDimension(R.styleable.windows2_layout_width2, 7);
        textColor_int = mTypedArray.getColor(R.styleable.windows2_textColor2, 0x00ada1de);
        textSize_float = mTypedArray.getDimension(R.styleable.windows2_textSize2, 50);
        max_int = mTypedArray.getInt(R.styleable.windows2_max2, 100);
        progress = mTypedArray.getInt(R.styleable.windows2_progress2, 100);
        thumb_double = mTypedArray.getDrawable(R.styleable.windows2_thumb2);
        thumbSize_int = mTypedArray.getInt(R.styleable.windows2_thumbSize2, 30);
        mTypedArray.recycle();
...
//            thumb_double = new BitmapDrawable(getResources(), bitmap);
        ...
        w = AutoUtils.getPercentHeightSize(340);
